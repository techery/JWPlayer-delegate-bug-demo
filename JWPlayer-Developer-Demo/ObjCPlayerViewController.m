...
@interface JWTestDelegateObject : NSObject <JWPlayerDelegate>

@end


@implementation JWTestDelegateObject
...
@property (nonatomic, strong) JWTestDelegateObject *delegateObject;
...
- (void)createPlayer
{
    ...
    self.delegateObject = [JWTestDelegateObject new];
...
-(void)onPlay
{
    ...
    self.player.delegate = self.delegateObject;
}
